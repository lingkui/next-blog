...
const PROJECT_NAME = process.env.PROJECT_NAME || 'next-blog';
const DATABASE_NAME = process.env.DATABASE_NAME || 'next-blog-db';
const KV_NAMESPACE_NAME = process.env.KV_NAMESPACE_NAME || 'next-blog-kv';
